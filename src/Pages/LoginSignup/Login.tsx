          ...
          <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 lg:p-12 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="text-center mb-12"> 
                ...
                <p className="text-xl text-gray-600 leading-relaxed">Sign in to your NCLEX Calendar account</p>
                ...
                <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-200/50">
                  <div className="flex items-center justify-center space-x-4">
                    <button
                      ...
                      className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg"
                    >
                      🚀 Fill Demo Credentials
                    </button>
                    <div className="text-sm text-blue-700">
                      <span className="font-semibold">Demo:</span> demo@nclexcalendar.com / demo123456
                    </div>
                  </div>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    className="text-sm text-indigo-600 hover:text-indigo-700 font-semibold transition-colors duration-200 hover:underline"
                  >
                    Forgot password?
                  </button>
                </div>
              ...
              <div className="mt-12 text-center">
                <p className="text-gray-600 text-base">
                  ...
                  <a href="/signup" className="text-indigo-600 hover:text-indigo-700 font-bold transition-colors duration-200 hover:underline">
                    Sign up
                  </a>
                </p>
              </div>
